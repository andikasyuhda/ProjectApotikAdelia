...
@php
    $stokAman = \App\Models\Medicine::where('stok', '>', \App\Models\Medicine::STOK_TINGGI)->count();
    $stokSedang = \App\Models\Medicine::whereBetween('stok', [\App\Models\Medicine::STOK_RENDAH, \App\Models\Medicine::STOK_TINGGI])->count();
        ...
        <div style="display: flex; flex-direction: column; gap: 16px;">
            ...
            <div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 6px;">
                    <span style="font-size: 14px; font-weight: 600; color: #10B981;">Stok Tinggi (>20)</span>
            ...
            <div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 6px;">
                    <span style="font-size: 14px; font-weight: 600; color: #F59E0B;">Stok Sedang (10-20)</span>
